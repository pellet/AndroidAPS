...
import info.nightscout.androidaps.plugins.aps.openAPSaiSMB.OpenAPSaiSMBFragment
...
abstract class FragmentsModule {
    ...
    @ContributesAndroidInjector abstract fun contributesOpenAPSaiSMBFragment(): OpenAPSaiSMBFragment
