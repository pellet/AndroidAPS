...
import info.nightscout.androidaps.plugins.aps.openAPSaiSMB.DetermineBasalAdapteraiSMB
import info.nightscout.androidaps.plugins.aps.openAPSaiSMB.DetermineBasalResultaiSMB
...
abstract class APSModule {
    ...
    @ContributesAndroidInjector abstract fun determineBasalResultaiSMBInjector(): DetermineBasalResultaiSMB
    ...
    @ContributesAndroidInjector abstract fun determineBasalAdapteraiSMBInjector(): DetermineBasalAdapteraiSMB
}